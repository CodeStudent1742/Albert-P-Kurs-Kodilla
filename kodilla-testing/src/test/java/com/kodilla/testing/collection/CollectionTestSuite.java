...
public class CollectionTestSuite {
    ...
    void testOddNumbersExterminatorNormalList() {
        ...
        List<Integer> expected = new ArrayList<Integer>(Arrays.asList(2,12));
        System.out.println(" normal list  content" + result);
        System.out.println(" Expected list  content" + expected);
        //Then
